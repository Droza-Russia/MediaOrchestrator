...
using MediaOrchestrator.Examples.Service;

namespace MediaOrchestrator.Examples
{
    internal static class Program
    {
        ...
        {
            Console.WriteLine("Usage: dotnet run --project MediaOrchestrator/Examples/MediaOrchestrator.Examples.csproj -- <scenario>");
